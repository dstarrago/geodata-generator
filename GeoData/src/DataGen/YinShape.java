 ...
 * @author Danel
 */
public class YinShape extends PrototypeShape {

  public YinShape(double x, double y, int w, int h) {
    super (x, y, w, h);
    createShape();
  }
    ...
    protected void createShape() {
      ...
      p1.curveTo(point.x + dim.width / 2, point.y,
              point.x + dim.width, point.y,
              point.x + dim.width, point.y + dim.height / 2);
      p1.lineTo(point.x + dim.width, point.y);
      p1.lineTo(point.x, point.y);
      p1.closePath();
